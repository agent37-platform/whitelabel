...
// The Composio "connect apps" body, used both in a dialog and as a full workspace tab.
// Lifecycle follows MOUNT: connections load on mount, polling and the debounced search clean
// up on unmount.
export function IntegrationsTab({ agentId, role }: { agentId: string; role: Role }) {
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-2">
                      {t.logo ? (
                        ...
                        <img src={t.logo} alt="" className="h-6 w-6 shrink-0 rounded" />
                      ) : (
